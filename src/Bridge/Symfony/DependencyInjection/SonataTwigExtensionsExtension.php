...
final class SonataTwigExtensionsExtension extends Extension
{
    ...
    public function registerFlashTypes(ContainerBuilder $container, array $config): void
    {
        $mergedConfig = array_merge_recursive($config['flashmessage'], [
            'success' => ['types' => [
                'success' => ['domain' => 'SonataTwigExtensionsBundle'],
            ...
            'warning' => ['types' => [
                'warning' => ['domain' => 'SonataTwigExtensionsBundle'],
                'sonata_flash_info' => ['domain' => 'SonataAdminBundle'],
            ]],
            'danger' => ['types' => [
                'error' => ['domain' => 'SonataTwigExtensionsBundle'],
